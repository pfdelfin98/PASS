...
class DeleteStudentDialog(QDialog):
    def setupUi(self, student_id):
        ...
        self.setWindowTitle("Archive Student")
        self.setGeometry(700, 300, 300, 150)

        self.confirmationLabel = QLabel(
            "Are you sure you want to archive this student?", self
        )
    ...
    def confirm_delete(self):
        ...
        try:
            ...
            if student_data:
                ...
                update_query = "UPDATE tbl_student SET status = 'Inactive' WHERE id = %s"
            ...
            if image_path:
                ...
                image_save_path = f"images/{image_filename}" 
                archived_image_folder = "archived_image"  
                ...
                if os.path.exists(image_save_path):
                    ...
                    print("Image file moved to archived_image folder successfully!")
